...
public class JwtService {
    ...
    private String secretKey = "4F2shqeYSZNfLeiC/jBCvOJ3/y9ekjttuuTiyXJyEZQF4428472B4B6250645367566B5970";
    ...
    public Claims extractAllClaims(String token) {
        // Logging the token before parsing
        ...
        try {
            ...
            throw new RuntimeException("Failed " +
                    "to parse JWT", e); // Rethrow as runtime exception
        }
    }
